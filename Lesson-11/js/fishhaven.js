function getWindChill() {
  ...
  const apiURL ="https://api.openweathermap.org/data/2.5/weather?id=5585010&units=imperial&appid=8ff253520018a0e2f77fa6d2d13cadb4";
  ...
  const apiURLfiveDay ="https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&APPID=8ff253520018a0e2f77fa6d2d13cadb4";
  ...
  .then(function(response) {
    ...
    .then(function(jsonObject) {
      ...
      for (let i = 0; i < currentEvents.length; i++) {
        if (
          currentEvents[i].name === "Fish Haven"
        ) {
          let card = document.createElement("section");
          let h2 = document.createElement("h2");
          let p2 = document.createElement("p");
